...
export const mockApi = {
  ...
  getModule: (id: string) => Promise.resolve(mockModules.find((m) => m.id === id) || null),

  getExercises: (moduleId?: string) =>
    Promise.resolve(moduleId ? mockExercises.filter((e) => e.module === moduleId) : mockExercises),

  getExercise: (id: string) => Promise.resolve(mockExercises.find((e) => e.id === id) || null),
